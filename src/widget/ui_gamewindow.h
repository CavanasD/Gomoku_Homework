...
public:
    ...
    void setupUi(QWidget *gameWindow)
    {
        ...
        label->setGeometry(QRect(620, 180, 141, 51));
        QFont font;
        ...
        whoTurn->setGeometry(QRect(600, 230, 291, 111));
        QFont font1;
        font1.setFamilies({QString::fromUtf8("\346\261\211\344\273\252\351\273\221\347\245\236\350\257\235")});
        font1.setPointSize(22);
        whoTurn->setFont(font1);
        whoWin = new QLabel(gameWindow);
        whoWin->setObjectName("whoWin");
        whoWin->setGeometry(QRect(60, 590, 441, 81));
        QFont font2;
        font2.setFamilies({QString::fromUtf8("\346\261\211\344\273\252\351\273\221\347\245\236\350\257\235")});
        font2.setPointSize(36);
        whoWin->setFont(font2);
        ...
        label_2->setGeometry(QRect(630, 360, 141, 51));
        label_2->setFont(font);
        label_3 = new QLabel(gameWindow);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(620, 490, 141, 51));
        label_3->setFont(font);
        whiteTimer = new QLCDNumber(gameWindow);
        whiteTimer->setObjectName("whiteTimer");
        whiteTimer->setGeometry(QRect(610, 550, 151, 61));
        ...
        blackTimer->setGeometry(QRect(610, 420, 151, 61));
